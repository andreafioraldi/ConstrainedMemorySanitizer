...
set(ALL_CMSAN_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  list_intersect(CMSAN_SUPPORTED_ARCH
    ALL_CMSANSAN_SUPPORTED_ARCH
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(CMSAN_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan;cmsan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND CMSAN_SUPPORTED_ARCH AND 
		OS_NAME MATCHES "Linux")
	set(COMPILER_RT_HAS_CMSAN TRUE)
else() 
	set(COMPILER_RT_HAS_CMSAN FALSE) 
endif()
